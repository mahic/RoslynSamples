...
namespace EmitApi
{
    ...
    {
        private static readonly IEnumerable<string> _defaultReferencesNames = new[]
        ...
        private static readonly IEnumerable<MetadataReference> _defaultReferences =
            _defaultReferencesNames.Select(y => MetadataReference.CreateFromFile(Path.Combine(_assemblyPath, y)));
